...
This privacy policy applies to the Daily Expense Tracker app (hereby referred to as "Application") for mobile devices that was created by Waleed Azhar (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".
